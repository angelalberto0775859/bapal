...
const steps = [
  ...
  },
  {
    ...
    img: p2,
    body: "Harinas orgánicas, masas rústicas y respeto absoluto por los tiempos de reposo. Sin atajos, sin aditivos.",
  },
  {
    n: "03",
    title: "Horneado del Día",
    img: p3,
    body: "Piezas que salen del horno directamente a las manos del cliente. Frescura instantánea, costra crujiente.",
  },
];
          ...
          {steps.map((s, i) => (
            ...
            >
              <div className="md:col-span-6">
                <div className="polaroid inline-block max-w-md">
                  <img
                    ...
                    height={900}
                  />
                  <p className="font-serif text-sm text-center mt-3 text-muted-foreground">
                    {s.title}
                  </p>
                </div>
              </div>
              <div className="md:col-span-6 md:pl-8">
                <span
                  aria-label={`Paso ${s.n}`}
                  className="inline-flex h-16 w-16 items-center justify-center rounded-full border border-accent/35 bg-background text-lg font-semibold tabular-nums tracking-normal text-accent shadow-sm md:h-20 md:w-20 md:text-2xl"
                >
                  {s.n}
                </span>
